...
ALLOWED_HOSTS = ['127.0.0.1', 'https://image-api.herokuapp.com']
#ALLOWED_HOSTS = ['127.0.0.1', 'image-api.herokuapp.com']
...
DATABASES = {
    ...
    'default1': {
        ...
        'NAME': 'mydb.db',  # This is where you put the name of the db file.
...
BASE_URL = 'https://image-api.herokuapp.com'
